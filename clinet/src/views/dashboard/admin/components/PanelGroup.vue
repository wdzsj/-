...
import { getBuildingInfo,getSum } from '@/api/building'
  ...
  watch: {
    buildingId(val) {
      if(val!==0){
        ...
        this.peopleNumCount=res.data.peopleNumCount
      })
      }else{
        getSum().then(res => {
      // console.log(res.data);

        this.buildingName = res.data.buildingCount
        this.layerCount = res.data.floorCount
        this.roomCount = res.data.roomCount
        this.userCount = res.data.userCount
        this.peopleNumCount=res.data.peopleNumCount

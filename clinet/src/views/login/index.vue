  ...
  <div class="login-container" >
    ...
    >
      ...
      <el-button
        ...
        :loading="loading"
        type="primary"
        style="width:100%;margin-bottom:30px;margin-left: 0;font-size:16px"
      ...
      <a class="toggle" @click="registerMode = !registerMode">
        <span v-if="!registerMode">教师注册</span>
...
<style scoped>
/* .login-container {
  background-image: url('../../assets/401_images/sj.jpg');
